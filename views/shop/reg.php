    ...
    <form action="#" method="post">
        <table class="zakaz-data" border="0" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <td class="zakaz-inpt"><input type="login" name="login" value="<?=$_SESSION['reg']['login']?>"/></td>
            ...
            <tr>
                <td class="zakaz-txt">Повторите пароль</td>
                <td class="zakaz-inpt"><input type="password" name="repass" /></td>
                <td class="zakaz-prim"></td>
            </tr>
            <tr>
